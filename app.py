...
st.set_page_config(page_title="Demo CBF in small business", layout="wide")
...
if user_query:
    ...
    if scores[ranking[0]] < threshold:
        st.warning("Cant find any stuff that you want !")
    else:
        best_idx = ranking[0]
        ...
        st.subheader("Maybe you like this product:")
